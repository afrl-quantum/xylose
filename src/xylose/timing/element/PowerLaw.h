...
#ifndef xylose_timing_element_PowerLaw_h
#define xylose_timing_element_PowerLaw_h
...
namespace xylose {
  namespace timing {
    namespace element {
      ...
      /** PowerLaw rise/fall timing element.
       ...
       */
      struct PowerLaw : timing::element::Base {
        /* TYPEDEFS */
...
#endif // xylose_timing_element_PowerLaw_h
